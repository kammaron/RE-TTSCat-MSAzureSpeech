...
namespace Re_TTSCat.Data
{
    public static class Vars
    {
        ...
        public static readonly string MSSSMLExample = "<speak xmlns=\"http://www.w3.org/2001/10/synthesis\" xmlns:mstts=\"http://www.w3.org/2001/mstts\" xmlns:emo=\"http://www.w3.org/2009/10/emotionml\" version=\"1.0\" xml:lang=\"zh-CN\"><voice name=\"$VOICE$\"><mstts:express-as style=\"$STYLE$\"><prosody rate=\"$SPEED$\" pitch=\"$PITCH$\">$CONTENT$</prosody></mstts:express-as></voice></speak>";
